...
public class CheckingDTO {
    ...
    public CheckingDTO(BigDecimal balance, AccountHolder primaryOwner, String name, AccountHolder secondaryOwnerId, String secretKey, Money minimumBalance, BigDecimal interestRate) {
    ...
    public CheckingDTO(Long id, String name) {
    }
